...
<body>
    ...
    <div class="container">
        ...
        <div class="body-section">
            <div class="row">
                <div class="col-6">
                    ...
                    <h2 class="heading">Invoice No.: 00{{ $order->id }}</h2>
                    <p class="sub-heading">Tracking No. {{ $order->order_number }}</p>
                    <p class="sub-heading">Order Date:{{ $order->created_at }} </p>
                    <p class="sub-heading">Email Address:{{ $order->customer->email }}</p>
                </div>
                <div class="col-6">
        ...
        <div class="body-section">
            ...
            <br>
            <h3 class="heading">Payment Status: {{ $order->status }}</h3>
            <h3 class="heading">Payment Mode: {{ $order->payment_ method }}</h3>
        </div>
 @endforeach
        <div class="body-section">
